...
export function retrieveLoading(retrieveLoading) {
  return { type: 'EVENT_UPDATE_RETRIEVE_LOADING', retrieveLoading };
}

export function retrieveSuccess(retrieved) {
  return { type: 'EVENT_UPDATE_RETRIEVE_SUCCESS', retrieved };
}
...
export function updateError(updateError) {
  return { type: 'EVENT_UPDATE_UPDATE_ERROR', updateError };
}

export function updateLoading(updateLoading) {
  return { type: 'EVENT_UPDATE_UPDATE_LOADING', updateLoading };
}

export function updateSuccess(updated) {
  return { type: 'EVENT_UPDATE_UPDATE_SUCCESS', updated };
}
...
export function mercureOpen(eventSource) {
  return { type: 'EVENT_UPDATE_MERCURE_OPEN', eventSource };
}
...
export function mercureMessage(retrieved) {
  return dispatch => {
    ...
    dispatch({ type: 'EVENT_UPDATE_MERCURE_MESSAGE', retrieved });
  };
}
